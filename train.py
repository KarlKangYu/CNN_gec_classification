...
def preprocess():
    ...
    vocab_processor = learn.preprocessing.VocabularyProcessor(max_document_length, min_frequency=500)#补0
    ...
    y_text_shuffled = y_text[shuffle_indices]
    ...
    y_text_train, y_text_dev = y_text_shuffled[:dev_sample_index], y_text_shuffled[dev_sample_index:]

    del x, y, x_shuffled, y_shuffled, y_text_shuffled
...
def train(x_train, y_train, y_text_train, vocab_processor, x_dev, y_dev, y_text_dev):
    # Training
    # ==================================================
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            def dev_step(x_batch, y_batch, y_text_batch, mask_y_text, writer=None):
                """
            ...
            batches = data_loader.batch_iter(
                list(zip(x_train, y_train, y_text_train)), FLAGS.batch_size, FLAGS.num_epochs)
            ...
            for batch in batches:
                ...
                if current_step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    dev_step(x_dev, y_dev, y_text_dev, mask_y_text_dev, writer=dev_summary_writer)
                    print("")
...
def main(argv=None):
    x_train, y_train, y_text_train, vocab_processor, x_dev, y_dev, y_text_dev = preprocess()
    train(x_train, y_train, y_text_train, vocab_processor, x_dev, y_dev, y_text_dev)
